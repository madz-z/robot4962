...
#pragma config(Motor,  mtr_S3_C1_1,     motorLF,       tmotorTetrix, openLoop, reversed, driveLeft, encoder)
#pragma config(Motor,  mtr_S3_C1_2,     motorLR,       tmotorTetrix, openLoop, reversed, driveLeft, encoder)
#pragma config(Motor,  mtr_S3_C2_1,     motorRF,       tmotorTetrix, openLoop, driveRight, encoder)
#pragma config(Motor,  mtr_S3_C2_2,     motorRR,       tmotorTetrix, openLoop, driveRight, encoder)
#pragma config(Motor,  mtr_S3_C3_1,     motorArm1,     tmotorTetrix, openLoop, encoder)
#pragma config(Motor,  mtr_S3_C3_2,     motorArm2,     tmotorTetrix, openLoop, encoder)
#pragma config(Motor,  mtr_S3_C4_1,     motorR,        tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S3_C4_2,     motorS,        tmotorTetrix, openLoop)
